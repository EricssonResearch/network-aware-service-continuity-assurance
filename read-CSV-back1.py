...
filename = open('backend-v1-cluster-1.csv', 'r')
...
sd = pd.read_csv('dependency-b1.csv')
sdtrace = pd.read_csv("backend-v1-cluster-1.csv", usecols=["timestamp","duration","bytes_sent","bytes_received","downstream_pod_ip","upstream_pod_ip"])
